...
function addListeners() {
    ...
    const fadeInStop = document.getElementById('fadeInStop');
    if (fadeInStop) {
        fadeInStop.addEventListener('click', function () {
            if (currentAnimation) {
    ...
    const scaleStop = document.getElementById('scaleStop');
    if (scaleStop) {
        scaleStop.addEventListener('click', function () {
            if (currentAnimation) {
                currentAnimation.stop();
                currentAnimation.reset();
                currentAnimation = null;
    ...
    const fadeOutPlay = document.getElementById('fadeOutPlay');
    if (fadeOutPlay) {
    ...
    const fadeOutStop = document.getElementById('fadeOutStop');
    if (fadeOutStop) {
        fadeOutStop.addEventListener('click', function () {
            if (currentAnimation) {
                currentAnimation.stop();
                currentAnimation.reset();
                currentAnimation = null;
    ...
    const moveAndHideStop = document.getElementById('moveAndHideStop');
    if (moveAndHideStop) {
        moveAndHideStop.addEventListener('click', function () {
            if (currentAnimation) {
                currentAnimation.stop();
                currentAnimation.reset();
                currentAnimation = null;
    ...
    const showAndHideStop = document.getElementById('showAndHideStop');
    if (showAndHideStop) {
        showAndHideStop.addEventListener('click', function () {
            if (currentAnimation) {
                currentAnimation.stop();
                currentAnimation.reset();
                currentAnimation = null;
    ...
    const worryAnimationPlay = document.getElementById('worryAnimationPlay');
    if (worryAnimationPlay) {
        const worryAnimationHandler = animaster()
            ...
            .addMove(200, {x: 0, y: 0})
            .buildHandler();
        worryAnimationPlay.addEventListener('click', worryAnimationHandler);
    }

    const rotatePlay = document.getElementById('rotatePlay');
    if (rotatePlay) {
    ...
    const rotateStop = document.getElementById('rotateStop');
    if (rotateStop) {
